...
void __fastcall TForm1::Zakocz1Click(TObject *Sender)
{
         ...
         if(Application->MessageBox(
                "Czy na pewno zakoñczyc program?", "PotwierdŸ",
                MB_YESNO | MB_ICONQUESTION) == IDYES)
                {
                   Application->Terminate();
                  //Application->Close();  W przypadku gdy jedno okienko
                }
}
//---------------------------------------------------------------------------
...
{
        ShellExecute(NULL, "open", "http://pakpro.prohost.pl", NULL, NULL, SW_SHOWNORMAL);        
}
//---------------------------------------------------------------------------
